module github.com/kubewharf/godel-scheduler

go 1.21.4

require github.com/agiping/flextopo-api v0.1.4
...
require (
	...
	k8s.io/csi-translation-lib v0.24.6
	k8s.io/klog v1.0.0
...
require (
	...
	k8s.io/metrics v0.24.6 // indirect
